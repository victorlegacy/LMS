                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin">
                        <div class="card" style="background-color: #36093845;">
                          <div class="card-body">
                            ...
                            <hr>
                                 <p class="text-dark">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore obcaecati reprehenderit commodi? Necessitatibus atque</p> <br>
                            ...
                            <label for="" class="text-secondary">Yesterday</label>
                          </div>
                        </div>
                      </div>
                    </div>
